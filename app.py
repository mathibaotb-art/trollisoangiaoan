...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Bạo - Trường Tiểu học Minh Quang - ĐT: 038 3895 224</p>
</div>
""", unsafe_allow_html=True)
    ...
    if not api_key: st.toast("Thiếu API Key!", icon="❌")
        ...
        try:
            with st.spinner('AI đang soạn giáo án (Times New Roman 14pt, A4, Căn lề chuẩn)...'):
                ...
                * Nội dung tích hợp (VD: Học thông qua chơi, Công dân số, năng lực số,...)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Bạo - Trường Tiểu học Minh Quang- ĐT: 038 3895 224</div>", unsafe_allow_html=True)
