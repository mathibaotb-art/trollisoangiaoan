...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Bạo - TrườngTiểu học Minh Quang - ĐT: 0383895224</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Bạo - Trường Tiểu học Minh Quang- ĐT: 0383895224</div>", unsafe_allow_html=True)
